...
function displayCart() {
  ...
  for(var i in cartArray) {
    output += "<tr><td><input type='text' name='prd_name[]' value='"+ cartArray[i].name +"'hidden><input type='text' name='pro_prc[]' value='"+ cartArray[i].price +"' hidden><td>"  
      ...
      + "<input type='text' class='item-count form-control' name='qty[]' data-name='" + cartArray[i].name + "' value='" + cartArray[i].count + "'><br>"
